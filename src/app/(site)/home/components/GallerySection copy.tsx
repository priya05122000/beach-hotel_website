...
function GalleryCard({
    ...
    return (
        <div
            className={`group relative overflow-hidden  p-0.75 bg-[linear-gradient(to_right,#012644,#FF992AC2,#012644,#012644,#FF992AC2,#012644)] bg-size-[250%] bg-left duration-1000 transition-all hover:bg-right shadow-xl ${className}`}
        >
