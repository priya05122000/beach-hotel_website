                    ...
                    <div className="px-6 sm:px-8 lg:px-0 lg:max-w-md xl:max-w-lg ">
                        <div className=" text-white ">
                            ...
                            <div className="space-x-4 mt-6 flex">
                                <button className=" bg-accent px-6 h-10 text-sm font-normal text-primary-dark shadow-lg uppercase">
                                    Sign in
                                </button>
                                <button className=" bg-white px-6 h-10 text-sm font-normal text-primary-dark shadow-lg  uppercase">
                                    Create Account
                                </button>
                            </div>
                        </div>
