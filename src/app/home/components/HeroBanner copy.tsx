          ...
          <div className="absolute bottom-10 left-1/2 z-20 w-full -translate-x-1/2">
            <CenterSection>
              ...
              >
                ...
                <button
                  type="submit"
                  className="h-10 bg-accent px-8 text-sm font-normal uppercase text-primary transition hover:opacity-90 cursor-pointer "
                >
                  Book Now
                </button>
              </form>
        ...
        <div className="z-0 text-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-4">
            <div className="mt-2 flex items-center justify-center gap-4">
              <Link
                href="/about-us"
                className="flex h-10  items-center justify-center  bg-accent px-6 text-sm font-normal uppercase text-primary shadow-lg"
              >
                About Us
              </Link>
              <Link
                href="tel:+911234567890"
                className="flex h-10  items-center justify-center  bg-white px-6 text-sm font-normal text-primary shadow-lg"
              >
                +91 12345 67890
              </Link>
            </div>
