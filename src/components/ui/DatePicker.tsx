        ...
        <div className="absolute bottom-[calc(100%+8px)] left-0 z-50 w-72 rounded-none bg-primary shadow-2xl border border-silver/60">
          <DayPicker
            ...
            classNames={{
              ...
              day_button:
                "w-9 h-9 flex items-center justify-center text-sm text-white rounded transition-colors cursor-pointer hover:bg-soft-accent hover:text-primary hover:font-bold",
